...
const IndexPage = () => {
  ...
  useEffect(() => {
    fetch("http://35.195.6.59:3005/api/menuItems")
    ...
    fetch("http://35.195.6.59:3005/api/getCompletedOrders")
      .then((response) => response.json())
      .then((data) => {
  ...
  const handleSubmitOrder = async () => {
    ...
    setSubmissionStatus("");
    try {
      const response = await fetch("http://35.195.6.59:3005/api/submitOrder", {
        method: "POST",
